...
def main():
    ...
    formula = input(colors.end + 'Please enter first a chemical formula: ' + colors.start_cyan)
    mass = input(colors.end + 'Please enter seconds the mass in grams: '+ colors.start_cyan)
...
# This function dermines how many moles are in the molecule based on the given mass.
...
# This is the main function which initializes each variable and calls the other functions
class colors:
